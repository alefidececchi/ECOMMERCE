...
const Leaflet = () => {
    ...
    return (
        <>
            {/* <NavBar title="React Leaflet Map Example"></NavBar> */}
            ...
            <div className="double" >
                ...
                <MapContainer center={center} zoom={ZOOM_LEVEL} ref={mapRef}>
                    ...
                    {/*<Marker position={[13.084622,277.248357]} icon={markerIcon}></Marker>
                    <Popup position={[13.084622,277.248357]} keepInView={true} closeButton={false}><b>TIENDA PREMIUM</b></Popup>*/}
                    {stores.map((store) =>
...
// <Popup position={[store.lat,store.lng]} keepInView={false} closeButton={true} key={store.key+10}><b>{store.name}</b></Popup>
